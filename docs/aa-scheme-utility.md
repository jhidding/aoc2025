...
```scheme
;| file: src/scheme/std/receive.scm
(library (std receive)
  (export receive)
  (import (rnrs (6)))
...
```scheme
;| file: src/scheme/utility/aux-keyword.scm
...
```scheme
;| file: src/scheme/utility/algorithms.scm
...
```scheme
;| file: src/scheme/std/format.scm
(library (std format)
  (export format)
