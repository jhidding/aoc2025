; ~/~ begin <<docs/aa-scheme-combinators.md#combinators::src/scheme/std/combinators.scm>>[init]
(library (std combinators)
  ...
  (import (rnrs)
      ; ~/~ begin <<docs/aa-scheme-combinators.md#combinators::combinators-import>>[init]
      (only (chezscheme) procedure-arity-mask make-wrapper-procedure)
      ; ~/~ end
  )
  ; ~/~ begin <<docs/aa-scheme-combinators.md#combinators::combinators>>[init]
  (define identity values)
  ; ~/~ end
  ; ~/~ begin <<docs/aa-scheme-combinators.md#combinators::combinators>>[1]
  (define (compose . fs)
    (fold-right compose-2 identity fs))
  ; ~/~ end
  ; ~/~ begin <<docs/aa-scheme-combinators.md#combinators::combinators>>[2]
  (define (vmap f)
      (lambda args
          (apply values (map f args))))
  ; ~/~ end
  ; ~/~ begin <<docs/aa-scheme-combinators.md#combinators::combinators>>[3]
  (define (iterate n)
    (lambda (f)
      (if (= n 0)
        identity
  ...
  ; ~/~ end
  ; ~/~ begin <<docs/aa-scheme-combinators.md#combinators::combinators>>[4]
  ...
  ; ~/~ end
  ; ~/~ begin <<docs/aa-scheme-combinators.md#combinators::combinators>>[5]
  (define (parallel . fs)
  ...
  (define (swap f)
    (lambda (x y) (f y x)))
  ; ~/~ end
  ; ~/~ begin <<docs/aa-scheme-combinators.md#combinators::combinators>>[7]
  (define (partial f . args1)
    (let ((a (procedure-arity-mask f)))
        (make-wrapper-procedure
            ...
            #f)))
  ; ~/~ end
  ; ~/~ begin <<docs/aa-scheme-combinators.md#combinators::combinators>>[8]
  (define const
    (case-lambda
      ((x _) x)
      ((x) (lambda (_) x))))
  ; ~/~ end
  ; ~/~ begin <<docs/aa-scheme-combinators.md#combinators::combinators>>[9]
  ...
  ; ~/~ end
  ; ~/~ begin <<docs/aa-scheme-combinators.md#combinators::combinators>>[10]
  (define melt
    (curry (x y z) ((x z) (y z))))
  ; ~/~ end
)
